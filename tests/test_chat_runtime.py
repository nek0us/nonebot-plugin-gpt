...
class ChatRuntimeTests(unittest.IsolatedAsyncioTestCase):
    async def test_agent_uses_an_isolated_control_conversation(self):
        ...
        self.assertEqual(service.requests[3].conversation_id, "agent-control")
        self.assertEqual(service.requests[3].parent_message_id, "agent-message")
        self.assertNotEqual(service.requests[3].conversation_id, "persona-conversation")
